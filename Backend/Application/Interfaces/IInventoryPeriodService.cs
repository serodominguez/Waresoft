...
namespace Application.Interfaces
{
    public interface IInventoryPeriodService
    {
        ...
        Task<BaseResponse<InventoryPeriodClosingResponseDto>> GetClosingByPeriod(int periodId);
        Task<BaseResponse<InventoryPeriodOpeningResponseDto>> GetOpeningByPeriod(int periodId);
