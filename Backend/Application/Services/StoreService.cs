...
namespace Application.Services
{
    public class StoreService : IStoreService
    {
        ...
        public async Task<BaseResponse<IEnumerable<StoreResponseDto>>> ListStores(BaseFiltersRequest filters)
        {
            ...
            try
            {
                var stores = _unitOfWork.StoreQuery.GetStoresListQueryable();
        ...
        public async Task<BaseResponse<IEnumerable<StoreSelectResponseDto>>> SelectListStores()
        {
        ...
        public async Task<BaseResponse<StoreResponseDto>> StoreById(int storeId)
        {
            ...
            try
            {
                var store = await _unitOfWork.StoreQuery.GetStoreByIdQueryable(storeId)
                    .FirstOrDefaultAsync();
        ...
        public async Task<BaseResponse<bool>> EditStore(int authenticatedUserId, int storeId, StoreRequestDto requestDto)
        {
            ...
            try
            {
                ...
                var store = await _unitOfWork.StoreCommand.GetByIdAsQueryable(storeId)
                    .FirstOrDefaultAsync();
