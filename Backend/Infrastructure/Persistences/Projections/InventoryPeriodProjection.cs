...
namespace Infrastructure.Persistences.Projections
{
    public static class InventoryPeriodProjection
    {
        ...
        public static Expression<Func<InventoryPeriodClosingEntity, InventoryPeriodClosingReadModel>> ToClosingSummary =>
            c => new InventoryPeriodClosingReadModel
            {
                IdPeriod = c.IdPeriod,
        ...
        public static Expression<Func<InventoryPeriodOpeningEntity, InventoryPeriodOpeningReadModel>> ToOpeningSummary =>
            o => new InventoryPeriodOpeningReadModel
            {
                IdPeriod = o.IdPeriod,
