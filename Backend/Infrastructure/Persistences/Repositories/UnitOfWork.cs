...
using Infrastructure.Persistences.Repositories.Dashboard;
...
namespace Infrastructure.Persistences.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IDashboardQueryRepository _dashboardQuery = null!;
        ...
        public IDashboardQueryRepository DashboardQuery => _dashboardQuery ?? new DashboardQueryRepository(_context);
