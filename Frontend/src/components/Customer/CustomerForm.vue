        ...
        <v-form ref="formRef" v-model="valid">
          <v-container class="pa-0">
            <v-row density="comfortable">
              <v-col cols="6" md="6">
                <v-text-field color="indigo" variant="solo" density="compact" v-model="localCustomer.names"
                  :rules="[rules.required, rules.onlyLetters]" counter="25" :maxlength="25" label="Nombre del cliente"
                  required />
              </v-col>
              <v-col cols="6" md="6">
                <v-text-field color="indigo" variant="solo" density="compact" v-model="localCustomer.lastNames"
              ...
              <v-col cols="6" md="6">
                <v-text-field color="indigo" variant="solo" density="compact" v-model="localCustomer.phoneNumber"
