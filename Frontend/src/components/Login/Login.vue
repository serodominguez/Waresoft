      ...
      <v-col cols="12" sm="8" md="6" lg="5" xl="4">
        <v-card :loading="loading">
          ...
          <v-card-text class="pb-0">
            <v-text-field v-model="user" color="indigo" label="Usuario" variant="outlined" @keyup="uppercase"
              :disabled="loading" required></v-text-field>
            <v-text-field v-model="password" color="indigo" label="Contraseña" variant="outlined"
